  ...
  return (
    <PageWrapper>
      <div className="max-w-3xl mx-auto prose dark:prose-invert">
        ...
        <p className="text-sm text-muted-foreground text-center mb-10">Last updated: {new Date().toLocaleDateString()}</p>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Information We Collect</h2>
        <p>We may collect information about you in a variety of ways. The information we may collect on the Site includes:</p>
        
        <h3 className="text-2xl font-semibold mt-8 mb-4">Personal Data</h3>
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Log Data and Analytics</h3>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Cookies</h2>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Third-Party Services</h2>
        <p>We may use third-party services for various purposes, including:</p>
        <ul className="list-disc list-inside space-y-1">
          <li><strong>Google AdSense:</strong> We use Google AdSense to display advertisements on our Site. Google AdSense may use cookies to serve ads based on a user's prior visits to our website or other websites. Google's use of advertising cookies enables it and its partners to serve ads to our users based on their visit to our sites and/or other sites on the Internet. Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer">Ads Settings</a>.</li>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Data Security</h2>
        <p>We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.</p>
        
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Children's Privacy</h2>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Changes to This Privacy Policy</h2>
        ...
        <h2 className="text-3xl font-bold mt-12 mb-6 border-b pb-3">Contact Us</h2>
