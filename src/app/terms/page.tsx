      ...
      <div className="max-w-3xl mx-auto space-y-10 md:space-y-12 pb-12">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">The tools and information provided on {APP_NAME} are for general informational and utility purposes only. We grant you a limited, non-exclusive, non-transferable, revocable license to use the Site for your personal, non-commercial use, or legitimate business purposes related to your role as a developer, content creator, or digital professional.</p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">You are responsible for your use of the tools and services provided on the Site. Any data you input into the tools is processed at your own risk. For tools that operate client-side, your data remains within your browser. For tools that may require server interaction (which will be clearly indicated), we take measures to protect data, but you acknowledge that transmission of information over the internet is not entirely secure.</p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">You agree to use the Site and its tools in a lawful manner and not for any purpose that is prohibited by these Terms or by applicable law.</p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">THE SITE AND ITS CONTENT, TOOLS, AND SERVICES ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. WE MAKE NO WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE SITE.</p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">WITHOUT LIMITING THE FOREGOING, NEITHER {APP_NAME} NOR ANYONE ASSOCIATED WITH {APP_NAME} REPRESENTS OR WARRANTS THAT THE SITE, ITS CONTENT, OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE SITE WILL BE ACCURATE, RELIABLE, ERROR-FREE, OR UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, THAT OUR SITE OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS, OR THAT THE SITE OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE SITE WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS.</p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">WE HEREBY DISCLAIM ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR PARTICULAR PURPOSE.</p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">You may use the Site only for lawful purposes and in accordance with these Terms. You agree not to use the Site:</p>
            <ul className="list-disc pl-6 space-y-3 text-lg text-muted-foreground leading-relaxed mb-6">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">The Site and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by {APP_NAME}, its licensors, or other providers of such material and are protected by copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">The Site may contain links to third-party websites or services that are not owned or controlled by {APP_NAME}. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services. You further acknowledge and agree that {APP_NAME} shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods, or services available on or through any such websites or services.</p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">The Site may display advertisements from third parties, such as Google AdSense. Your interactions with these advertisements are governed by the terms and policies of the third-party advertisers.</p>
        </section>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">If you have any questions about these Terms of Use, please <a href="/contact" className="text-primary hover:underline">contact us</a>.</p>
        </section>
