...
export const tools: Tool[] = [
  // Text & String Tools
  {
    ...
    description:
      "Efficiently remove or replace line breaks and optionally clean up whitespace from your text.",
    ...
    longDescription: {
      ...
      howItWorks:
        'Paste your text into the input area. Select your desired options: Check "Remove Empty Lines" to eliminate blank lines. Check "Trim Leading/Trailing Spaces from Each Line" to remove whitespace from the start and end of each line. Choose a "Separator" from the dropdown: "Space" replaces line breaks with a single space, while "None" removes them completely. Click the "Remove" button to process. The cleaned text will appear in the output area.',
      tips: [
    ...
    faqs: [
      {
        question: "What types of line breaks does the tool handle?",
        answer:
          "It handles standard line break characters including \\n (LF - Unix/Linux/macOS), \\r\\n (CRLF - Windows), and \\r (CR - older Mac systems).",
      },
      {
        question: 'How does "Remove Empty Lines" work with "Trim Spaces"?',
        answer:
          'If both are checked, lines are first trimmed. If a line becomes empty after trimming (i.e., it only contained spaces), it will then be removed by the "Remove Empty Lines" option.',
      },
      {
        question:
          "Can I replace line breaks with something other than a single space or nothing?",
        answer:
          "Currently, the tool supports replacing line breaks with a single space or removing them entirely. For custom separators, you might need a more advanced text manipulation tool or a find-and-replace utility with regex capabilities.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "No, all processing is done client-side within your browser. Your text is not uploaded or stored anywhere.",
      },
    ],
    keywords: [
      "text",
    ...
    faqs: [
      {
        ...
        answer:
          "Title Case capitalizes the first letter of each word. Our implementation capitalizes every word for simplicity.",
      },
      {
        question: 'What is "Sentence case"?',
        answer:
          "Sentence case capitalizes the first letter of each sentence. It identifies sentences based on common punctuation like periods, question marks, and exclamation marks.",
      },
      {
        question:
          "How do camelCase, PascalCase, snake_case, and kebab-case work?",
        answer:
          "These are common programming case styles. camelCase starts with a lowercase letter and subsequent words are capitalized (e.g., `myVariableName`). PascalCase capitalizes every word (e.g., `MyClassName`). snake_case separates words with underscores, all lowercase (e.g., `my_variable_name`). kebab-case separates words with hyphens, all lowercase (e.g., `my-css-class`).",
      },
      {
        question: "Is my text sent to a server?",
        answer:
          "No, all case conversions are performed client-side in your browser.",
      },
    ],
    keywords: [
      "text case",
    ...
    faqs: [
      {
        ...
        answer:
          "Words are generally counted by splitting the text by spaces and common punctuation. Different tools might have slightly different rules.",
      },
      {
        question: "How are sentences counted?",
        answer:
          "Sentences are typically counted based on the presence of terminal punctuation like periods (.), question marks (?), and exclamation marks (!), often followed by a space or the end of the text.",
      },
      {
        question: "How are paragraphs counted?",
        answer:
          "Paragraphs are usually identified by one or more blank lines (double line breaks) between blocks of text.",
      },
      {
        question: "Is my text sent to a server for counting?",
        answer:
          "No, all counting operations are performed client-side within your browser. Your text remains private.",
      },
    ],
    keywords: [
      "word count",
  ...
  },
  {
    ...
    description:
      "Analyze text for sentences, syllables, words, characters, reading time, and top keywords.",
    category: "text-string",
    ...
    longDescription: {
      ...
      howItWorks:
        "Paste your text into the provided area. The tool automatically analyzes it to provide: Sentence Count (based on terminal punctuation), Word Count, Character Count (total characters), Syllable Count (using a heuristic for English words), estimated Reading Time (based on an average reading speed), and a list of Top Keywords (excluding common stop words). All calculations are performed client-side.",
      tips: [
    ...
    faqs: [
      {
        ...
        answer:
          "Sentences are primarily identified by terminal punctuation marks such as periods (.), question marks (?), and exclamation marks (!), followed by a space or new line. Abbreviations or other uses of periods might affect accuracy.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Reading time is typically estimated based on an average reading speed of around 200-250 words per minute. The tool uses this average to calculate the estimated time in seconds or minutes.",
      },
      {
        question: 'How are "Top Keywords" identified?',
        answer:
          'The text is broken into words, converted to lowercase, and common "stop words" (like "the", "is", "a") are removed. The frequency of the remaining words is then counted, and the most frequent ones are displayed.',
      },
      {
        question: "Is this tool suitable for very long texts?",
        answer:
          "While it can handle substantial text, extremely large inputs (many megabytes) might cause browser performance to slow down as all analysis is done client-side.",
      },
    ],
    keywords: [
      "sentence count",
    ...
    faqs: [
      {
        ...
        answer:
          "A URL slug is the part of a URL that identifies a particular page on a website in an easy-to-read form. It’s the part of the URL that comes after the domain name and any directory paths, typically derived from the page title.",
      },
      {
        question: "Why are dashes preferred over underscores in slugs?",
        answer:
          'Search engines like Google have historically treated hyphens as word separators, while underscores were sometimes treated as joiners (making "word_one" look like "wordone"). Using dashes ensures words are recognized individually.',
      },
      {
      ...
      },
      {
        ...
        answer:
          "This option typically removes any character that is not a letter (a-z, A-Z), a number (0-9), or a space (which is then converted to your chosen separator). It helps create clean, universally accepted URL slugs.",
      },
      {
        question: "Is my input text sent to a server?",
        answer:
          "No, all slug generation is performed client-side within your browser. Your input remains private.",
      },
    ],
    keywords: [
      "url slug",
  ...
  // Developer Tools
  {
    ...
    faqs: [
      {
        question: 'What does "valid JSON" mean?',
        answer:
          "Valid JSON strictly adheres to its syntax rules: keys must be double-quoted strings, string values must be double-quoted, objects are enclosed in curly braces `{}`, arrays in square brackets `[]`, and elements are separated by commas. No trailing commas are allowed.",
      },
      {
        question: "What indentation level is used for formatting?",
        answer:
          "The tool uses a standard 2-space indentation for pretty-printing the JSON.",
      },
      {
        question: "Is my JSON data sent to any server?",
        answer:
          "No, all formatting and validation operations are performed client-side within your browser. Your data remains private.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Standard JSON does not support comments. If your input contains comments (e.g., `//` or `/* */`), the validator will treat it as invalid JSON.",
      },
    ],
    keywords: [
      "json",
  ...
  },
  {
    ...
    longDescription: {
      ...
      howItWorks:
        'When you click the "Generate UUID" button, the tool utilizes the `crypto.randomUUID()` method provided by modern web browsers. This method generates a cryptographically strong random Version 4 UUID, conforming to RFC 4122. The generated UUID is then displayed in the output field.',
      tips: [
    ...
    faqs: [
      {
        question: "What version of UUID is generated by this tool?",
        answer:
          "This tool generates Version 4 UUIDs, which are based on random numbers.",
      },
      {
        question: "Are the generated UUIDs truly unique?",
        answer:
          "While not mathematically guaranteed to be unique across every system in the universe for all time, the probability of two independently generated v4 UUIDs colliding is so infinitesimally small that they are considered practically unique for most applications.",
      },
      {
        question: "How are v4 UUIDs generated?",
        answer:
          "They are generated using random or pseudo-random numbers. The `crypto.randomUUID()` browser API leverages a cryptographically secure random number generator.",
      },
      {
        question: "Is my generated UUID stored anywhere?",
        answer:
          "No, the UUID is generated client-side in your browser and is not sent to or stored on any server.",
      },
      {
        question: "Can I generate other versions of UUIDs (e.g., v1, v3, v5)?",
        answer:
          "Currently, this tool focuses on generating v4 UUIDs, which are the most commonly used random UUIDs. Generating other versions typically requires different inputs (like MAC addresses for v1 or names/namespaces for v3/v5) and more complex logic.",
      },
    ],
    keywords: [
      "uuid",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "Does this tool verify the signature of the JWT?",
        answer:
          "No, this tool only decodes the header and payload. It does not perform signature validation. To validate the signature, you need the corresponding secret or public key.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Ensure you are pasting the complete and unmodified JWT string. JWTs use Base64Url encoding, which is slightly different from standard Base64. The tool handles this, but corrupted or incomplete tokens will fail to decode properly.",
      },
      {
        question: "Is my JWT data sent to a server?",
        answer:
          "No, all decoding operations are performed client-side within your browser. Your JWT data remains private.",
      },
    ],
    keywords: [
      "jwt",
    ...
    faqs: [
      {
        ...
        answer:
          'This is the most common cron expression and means "run every minute of every hour of every day of every month of every day of the week".',
      },
      {
        question: "How do I schedule a task for 2:30 AM every day?",
        answer:
          "You would use: `30 2 * * *` (At minute 30 past hour 2 on every day-of-month on every month on every day-of-week).",
      },
      {
        question: "Can I schedule tasks for specific years?",
        answer:
          "Standard cron (5-field format) does not include a year field. Some extended cron versions or specific schedulers might, but this tool focuses on the common 5-field format.",
      },
      {
        question:
    ...
    faqs: [
      {
        ...
        answer:
          "Generally, no. Minification aims to remove only characters that are not needed for the CSS to function. However, poorly written or very complex CSS might occasionally have issues if the minifier is too aggressive or if there are syntax errors in the original CSS. Always test after minifying.",
      },
      {
        question: "How much can I expect my CSS file size to reduce?",
        answer:
          "This varies greatly depending on the original CSS. Files with many comments and a lot of whitespace will see a more significant reduction. Reductions of 10-50% are common.",
      },
      {
        question:
          "Can this tool minify CSS with preprocessor syntax (like SASS or LESS)?",
        answer:
          "No, this tool expects standard CSS. You should compile your SASS/LESS to CSS first, and then minify the resulting CSS file.",
      },
      {
        question: "Does this tool handle CSS variables (custom properties)?",
        answer:
          "Yes, it should preserve CSS custom properties as they are valid CSS syntax.",
      },
      {
        question: "Is my CSS code sent to a server?",
        answer:
          "No, all minification is performed client-side within your browser. Your code remains private.",
      },
    ],
    keywords: [
      "css",
  ...
  },
  {
    ...
    longDescription: {
      overview:
        "The Color Picker & Converter tool allows designers and developers to easily select colors using a visual interface and instantly get their corresponding HEX, RGB, and HSL values. It also provides the ability to copy these values to the clipboard for use in web projects, design software, or any other application where color codes are needed.",
      useCases: [
    ...
    faqs: [
      {
        ...
        answer:
          "It supports HEX (e.g., #RRGGBB), RGB (e.g., rgb(R, G, B)), and HSL (e.g., hsl(H, S%, L%)).",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, the conversions between HEX, RGB, and HSL are based on standard color model formulas to ensure accuracy.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "No, the color selection and conversions happen in your browser. The tool does not store your color choices on any server.",
      },
    ],
    keywords: [
      "color picker",
    ...
    faqs: [
      {
        ...
        answer:
          "You can create linear gradients (progressing in a straight line) and radial gradients (radiating from a central point).",
      },
      {
        question: "How many color stops can I add?",
        answer:
          "The tool allows adding multiple color stops to create complex gradients. We recommend at least two.",
      },
      {
        question: "Is the generated CSS cross-browser compatible?",
        answer:
          "The tool generates standard CSS gradient syntax, which is well-supported by all modern browsers. For very old browsers, fallbacks might be needed, but the tool focuses on current standards.",
      },
      {
        question: "Can I save my created gradients?",
        answer:
          "Currently, the tool doesn_t have a save feature. You should copy the generated CSS for use in your projects.",
      },
    ],
    keywords: [
      "css gradient",
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: "Does this tool work for `text-shadow` too?",
        answer:
          "No, this tool is specifically for `box-shadow`. The `text-shadow` property has a similar syntax but applies to text characters.",
      },
    ],
    keywords: [
      "css box shadow",
    ...
    faqs: [
      {
        ...
        answer:
          "This tool allows you to use pixels (`px`) and percentages (`%`).",
      },
      {
        question: "How do I make a perfect circle?",
        answer:
          'For a square element, set its `border-radius` to `50%` using the "%" unit setting.',
      },
      {
        question:
          "Can I set different horizontal and vertical radii for a corner (elliptical corners)?",
        answer:
          "The standard `border-radius` property allows this by using a slash (e.g., `border-top-left-radius: 20px / 40px;`). This version of the tool focuses on a single radius value per corner for simplicity.",
      },
      {
        question: "What is the shorthand for `border-radius`?",
        answer:
          "`border-radius: value;` (all corners), `border-radius: top-left-and-bottom-right top-right-and-bottom-left;` (two values), `border-radius: top-left top-right-and-bottom-left bottom-right;` (three values), or `border-radius: top-left top-right bottom-right bottom-left;` (four values).",
      },
    ],
    keywords: [
      "css border radius",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "What type of waves can I generate?",
        answer:
          "Currently, this tool specializes in generating sine-wave based shapes. Support for square or triangle waves may be added in the future.",
      },
      {
        question: 'How is the "Complexity" parameter related to frequency?',
        answer:
          'Higher "Complexity" values mean more wave cycles (higher frequency) across the width of the SVG, resulting in more crests and troughs.',
      },
      {
        question: "Can I create multiple overlapping waves or layers?",
        answer:
          "This tool generates a single wave shape at a time. To create layered effects, you would generate multiple SVGs and position them using CSS or an SVG editor.",
      },
      {
        question: "Is the downloaded SVG optimized?",
        answer:
          "The generated SVG is fairly clean. For further optimization, you could run it through an SVG minifier tool.",
      },
      {
        question: "How does the horizontal flip work?",
        answer:
          "The current horizontal flip simply reverses the order of the points used to draw the wave. For a symmetrical sine wave, this might not produce a visually distinct horizontal flip without further transformation logic.",
      },
    ],
    keywords: [
      "svg wave",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "This tool focuses on generative creation through parameters. For fine-grained manual control over each point and curve, you would typically use a vector graphics editor like Inkscape or Adobe Illustrator.",
      },
      {
        question: "Are the blobs always filled shapes?",
        answer:
          "Yes, this generator creates filled SVG paths. You can modify the SVG code later if you need only an outline (stroke) or want to apply other SVG effects.",
      },
      {
        question: 'What does the "seed" do?',
        answer:
          'The seed is an internal random number used in the generation process. Changing the seed (which the "Randomize" button does) results in a different blob shape even if other parameters are the same.',
      },
    ],
    keywords: [
      "svg blob",
  ...
  // Conversion Tools
  {
    ...
    faqs: [
      ...
      {
        question:
          "How does the tool handle commas or newlines within CSV fields?",
        answer:
          'The parser is designed to correctly handle fields enclosed in double quotes. If a field value contains a comma, newline, or double quotes, it should be enclosed in double quotes (e.g., "value, with comma"). Double quotes within a quoted field should be escaped by doubling them (e.g., "field with ""quotes""").',
      },
      {
        question:
      ...
      },
      {
        ...
        answer:
          "No, all CSV parsing and JSON conversion happen directly in your browser. Your data is not sent to any server, ensuring privacy.",
      },
    ],
    keywords: [
      "csv to json",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "This tool supports common Markdown features: headings (#, ##, ...), bold (**text** or __text__), italic (*text* or _text_), links ([text](url)), images (![alt](url)), unordered lists (*, -, +), ordered lists (1.), blockquotes (>), inline code (`code`), and fenced code blocks (```).",
      },
      {
        question: "Can I convert HTML back to Markdown with this tool?",
        answer:
          "No, this tool only converts Markdown to HTML. For HTML to Markdown conversion, you would need a different utility.",
      },
      {
        question: "Is the HTML output perfectly standard?",
        answer:
          "The tool aims to generate standard HTML5. However, due to the simplified nature of the regex-based parser, extremely complex or malformed Markdown might not convert perfectly. Always review the output.",
      },
      {
        question: "Does this tool send my Markdown to a server?",
        answer:
          "No, all conversion and rendering happen client-side in your browser. Your data remains private.",
      },
    ],
    keywords: [
      "markdown",
    ...
    faqs: [
      {
        ...
        answer:
          "RGB is an additive color model in which red, green, and blue light are added together in various ways to reproduce a broad array of colors. Each component can range from 0 to 255.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "This tool focuses on converting standard RGB to HEX. For RGBA to HEXA (HEX with alpha), you would need a different conversion.",
      },
    ],
    keywords: [
      "rgb to hex",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "How does a 3-digit HEX code work?",
        answer:
          "A 3-digit HEX code like #RGB is a shorthand where each digit is duplicated. For example, #F0A becomes #FF00AA.",
      },
      {
        question: "What if I enter an invalid HEX code?",
        answer:
          "The tool will attempt to parse valid HEX characters (0-9, A-F). If the input is not a valid 3 or 6-digit HEX code, it will likely result in an error or an incorrect color display.",
      },
      {
        question: "Can this tool handle HEX codes with alpha (HEXA)?",
        answer:
          "This tool focuses on standard 3 or 6-digit HEX codes for opaque colors. For HEX codes with an alpha channel (e.g., #RRGGBBAA), you would need a tool that specifically supports RGBA conversion.",
      },
    ],
    keywords: [
      "hex to rgb",
  ...
  // Security Tools
  {
    ...
    longDescription: {
      overview:
        "The Password Generator helps you create strong, random passwords tailored to your security needs. You can customize the length and include or exclude uppercase letters, lowercase letters, numbers, and symbols. Strong passwords are crucial for protecting your online accounts and sensitive information.",
      useCases: [
    ...
    faqs: [
      {
        ...
        answer:
          "The passwords are generated using cryptographically secure random number generation available in the browser (window.crypto.getRandomValues), ensuring a high degree of randomness.",
      },
      {
        question: "Is it safe to use an online password generator?",
        answer:
          "This tool generates passwords client-side, meaning the password is created in your browser and not sent over the internet or stored on our servers. This makes it safe to use. However, always ensure you are on the correct website (check the URL) when using any online security tool.",
      },
      {
        question: "What is the maximum password length I can generate?",
        answer:
          "The tool typically supports lengths up to 128 characters, which is more than sufficient for most purposes.",
      },
      {
        question: "Which symbols are included?",
        answer:
          "The symbols set generally includes common special characters like !@#$%^&amp;*()_+-=[]{}|;:,.<>/?~`.",
      },
      {
        question: "Can I save the generated passwords here?",
        answer:
          "No, this tool does not store your generated passwords. You should copy the password and store it securely, preferably in a reputable password manager.",
      },
    ],
    keywords: [
      "password generator",
    ...
    faqs: [
      {
        ...
        answer:
          "A cryptographic hash function is a mathematical algorithm that maps data of arbitrary size to a bit array of a fixed size (the hash). It is a one-way function, meaning it is infeasible to invert or reverse the computation.",
      },
      {
        question: "Why are MD5 and SHA-1 not offered?",
        answer:
          "MD5 and SHA-1 are considered cryptographically broken and insecure for most modern applications due to collision vulnerabilities. We offer stronger, currently secure algorithms like SHA-256 and above.",
      },
      {
      ...
      },
      {
        question: "Is my input text sent to a server?",
        answer:
          "No, all hashing is performed client-side within your browser using the Web Crypto API. Your input text remains private.",
      },
      {
        question: "Can I hash files with this tool?",
        answer:
          "Currently, this tool is designed for text input. Hashing files would require file reading capabilities, which could be added as a future enhancement.",
      },
    ],
    keywords: [
      "hash generator",
    ...
    faqs: [
      {
        ...
        answer:
          "No, MD5 is not considered secure for cryptographic purposes such as password hashing or ensuring data authenticity against malicious attacks. It has known collision vulnerabilities. However, it can still be used for non-cryptographic checksums to detect accidental data corruption.",
      },
      {
      ...
      },
      {
        question: "Is my input text sent to a server?",
        answer:
          "No, all MD5 hashing with this tool is performed client-side within your browser. Your input text remains private.",
      },
    ],
    keywords: [
      "md5 hash",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "No, Base64 is easily reversible and should never be used for storing or transmitting sensitive information like passwords securely. Use proper hashing and encryption for security.",
      },
      {
        question: "Why does `atob()` sometimes throw an error?",
        answer:
          "The `atob()` function will throw an error if the input string is not a valid Base64 encoded string (e.g., contains characters not in the Base64 alphabet or has incorrect padding). Our tool attempts to handle common UTF-8 scenarios, but malformed Base64 will still fail.",
      },
    ],
    keywords: [
      "base64",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "`encodeURI()` is intended for encoding a full URI and does not encode characters like :, /, #, ?, &. `encodeURIComponent()` is for encoding URI components (like query parameters or path segments) and encodes more characters, making it generally safer for individual parts of a URL.",
      },
      {
        question: "What happens if I try to decode a non-URL-encoded string?",
        answer:
          "`decodeURIComponent()` will generally return the string as is if there are no %-encoded sequences. If it encounters invalid % sequences, it might throw an error.",
      },
    ],
    keywords: [
      "url encoder",
    ...
    faqs: [
      {
        ...
        answer:
          "A Unix timestamp is the total number of seconds that have elapsed since 00:00:00 UTC on January 1, 1970, not counting leap seconds. Some systems use milliseconds instead of seconds.",
      },
      {
        question: "Are timezones handled?",
        answer:
          "When converting from a timestamp to a human-readable date, the output is generally displayed in your local browser timezone. When converting from a date to a timestamp, the JavaScript `Date` object typically works with UTC internally for timestamp generation.",
      },
      {
        question: "Can I input a date string manually?",
        answer:
          "Yes, you can type a date string into the date input field. The browser will attempt to parse it. For best results, use a common format like YYYY-MM-DDTHH:mm.",
      },
      {
        question: "Why is my converted date off by a few hours?",
        answer:
          "This is almost always due to timezone differences. Unix timestamps are timezone-agnostic (based on UTC), while human-readable dates are often interpreted in a local timezone.",
      },
    ],
    keywords: [
      "timestamp converter",
  ...
  },
  {
    ...
    description:
      "Generate placeholder text (Lorem Ipsum) for your designs and mockups.",
    category: "productivity",
    ...
    longDescription: {
      ...
      howItWorks:
        'Select the type of content you want to generate (e.g., paragraphs, sentences, or words). Enter the desired quantity (e.g., 5 paragraphs, 10 sentences). Click the "Generate" button. The tool will then produce the specified amount of Lorem Ipsum text in the output area, ready for you to copy and use.',
      tips: [
    ...
    faqs: [
      ...
      {
        question:
          'Why use Lorem Ipsum instead of just repeating "text text text"?',
        answer:
          "Lorem Ipsum has a more natural-looking distribution of letters and word lengths compared to simple repetition, making it a better visual placeholder for actual content.",
      },
      {
        question: "Can I generate Lorem Ipsum in other languages?",
        answer:
          "This specific tool generates standard Lorem Ipsum, which is Latin-like. Generating placeholder text in other languages would require different source texts.",
      },
      {
        question: "Is the generated text always the same?",
        answer:
          "The tool uses a predefined block of Lorem Ipsum text and selects portions of it based on your request. For a small number of words/sentences, it might appear repetitive, but for paragraphs, it typically shuffles sentences to create variety.",
      },
    ],
    keywords: [
      "lorem ipsum",
  ...
  },
  {
    ...
    faqs: [
      {
        question:
          "What if I only have minutes and seconds for the original duration?",
        answer: 'Simply leave the "hours" field as 0 or empty.',
      },
      {
        question: "Can I input a playback speed like 1.25x?",
        answer: "Yes, the custom speed input accepts decimal values.",
      },
      {
        question: 'How is "time saved" calculated?',
        answer:
          'Time saved is the original duration minus the new estimated duration. If the new duration is longer (speed < 1x), the "time saved" will be negative, meaning additional time spent.',
      },
      {
  ...
  },
  {
    ...
    description:
      "Calculate new audiobook listening time based on playback speed and see time saved.",
    category: "productivity",
    icon: Icons.BookText,
    iconName: "BookText",
    ...
    longDescription: {
      overview:
        "The Audiobook Speed Calculator helps you estimate how long it will take to listen to an audiobook at different playback speeds. It also calculates the total time you can save by listening at a faster pace, or the extra time it might take if you slow it down.",
      useCases: [
    ...
    faqs: [
      {
        question: "How accurate is the listening time calculation?",
        answer:
          "The calculation is mathematically precise based on the inputs. The actual comprehension and enjoyment can vary per individual at different speeds.",
      },
      {
        question: "Can I use decimal speeds like 1.3x?",
  ...
  },
  {
    ...
    description:
      "Calculate optimal wake-up or bedtimes based on natural sleep cycles.",
    category: "productivity",
    icon: Icons.Bed,
    iconName: "Bed",
    ...
    longDescription: {
      ...
      howItWorks:
        'Choose your calculation mode: "I plan to sleep at..." or "I want to wake up at...". If sleeping at a certain time, enter your planned bedtime and the estimated time it takes you to fall asleep. The tool will calculate several potential wake-up times based on completing full 90-minute sleep cycles. If waking up at a certain time, enter your desired wake-up time and fall asleep duration. The tool will suggest optimal bedtimes. Results for 5 or 6 sleep cycles (7.5 to 9 hours of sleep) are often highlighted as recommended for adults.',
      tips: [
    ...
    faqs: [
      {
        ...
        answer:
          "A sleep cycle consists of several stages of sleep, including light sleep, deep sleep, and REM (Rapid Eye Movement) sleep. Each full cycle typically lasts about 90 minutes.",
      },
      {
        question: "Why is it better to wake up at the end of a sleep cycle?",
        answer:
          "Waking up at the end of a cycle, when you are in a lighter stage of sleep, generally makes you feel more refreshed and less groggy than if you wake up abruptly during deep sleep or REM sleep.",
      },
      {
        question: "How accurate is the 90-minute cycle assumption?",
        answer:
          "While 90 minutes is a good average, individual sleep cycles can range from 70 to 120 minutes. This calculator uses the 90-minute average as a guideline.",
      },
      {
        question: "What if I don_t know how long it takes me to fall asleep?",
        answer:
          "The average time is 10-20 minutes. You can start with 15 minutes and adjust based on your experience. If you fall asleep very quickly or take much longer, update the slider accordingly.",
      },
      {
  ...
  // Calculator Tools
  {
    ...
    description:
      "Calculate slope percentage from rise and run, or angle of inclination.",
    category: "calculator",
    icon: Icons.Sigma,
    iconName: "Sigma",
    ...
    longDescription: {
      overview:
        "The Slope Percentage Calculator helps you determine the steepness of a slope. You can input the vertical rise and horizontal run, or directly input the angle of inclination. The tool provides the slope as a percentage and visualizes it with a diagram.",
      useCases: [
    ...
    faqs: [
      {
        question: "What is slope percentage?",
        answer:
          "Slope percentage represents the ratio of vertical rise to horizontal run, multiplied by 100. It indicates how steep an incline or decline is.",
      },
      {
        question: "How do I convert an angle in degrees to slope percentage?",
        answer:
          "First, convert the angle from degrees to radians (angle_in_radians = angle_in_degrees * π / 180). Then, calculate tan(angle_in_radians). Finally, multiply by 100 to get the percentage.",
      },
      {
        question: "What if my run is zero?",
        answer:
          "If the run is zero and the rise is non-zero, the slope is technically undefined (vertical). The calculator will indicate an error or infinite slope.",
      },
      {
        question: "Can I calculate a negative slope (decline)?",
        answer:
          'Yes, if the "rise" is negative (representing a drop in elevation), the slope percentage will be negative, indicating a decline.',
      },
    ],
    keywords: [
      "slope calculator",
  ...
  },
  {
    ...
    longDescription: {
      overview:
        "The Temperature Converter allows for quick and easy conversion between the three most common temperature scales: Celsius (°C), Fahrenheit (°F), and Kelvin (K). Input a temperature in one scale, and the tool will instantly display its equivalent in the other two scales.",
      useCases: [
      ...
      howItWorks:
        'Enter a temperature value into any of the input fields (Celsius, Fahrenheit, or Kelvin). As you type, the other fields will automatically update with the converted values based on standard conversion formulas. For example, if you type "0" in Celsius, Fahrenheit will show "32" and Kelvin will show "273.15".',
      tips: [
    ...
    faqs: [
      {
        question: "What are the formulas for conversion?",
        answer:
          "C to F: (C * 9/5) + 32. F to C: (F - 32) * 5/9. C to K: C + 273.15. K to C: K - 273.15. F to K: (F - 32) * 5/9 + 273.15. K to F: (K - 273.15) * 9/5 + 32.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Convert lengths and distances between various units like meters, kilometers, feet, miles, and inches.",
    category: "calculator",
    icon: Icons.Ruler,
    iconName: "Ruler",
    ...
    longDescription: {
      overview:
        'The Length Converter enables easy conversion of measurements between different units of length, including metric (meters, kilometers) and imperial/US customary units (feet, miles, inches). Input a value in one unit and select the "from" and "to" units to see the conversion.',
      useCases: [
      ...
      howItWorks:
        'Enter the value you wish to convert in the "Value" input field. Select the unit you are converting "From" using the first dropdown. Select the unit you want to convert "To" using the second dropdown. The converted value will be displayed automatically. The tool uses standard conversion factors to perform the calculations.',
      tips: [
    ...
    faqs: [
      {
        ...
        answer:
          "The tool typically supports meters (m), kilometers (km), feet (ft), miles (mi), and inches (in). More units could be added.",
      },
      {
        question: "How accurate are the conversions?",
        answer:
          "Conversions are based on standard, internationally recognized conversion factors, ensuring high accuracy.",
      },
    ],
    keywords: [
      "length converter",
  ...
  // AI Powered Tools
  {
    ...
    faqs: [
      {
        question: "What are conventional commit messages?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes, the input you provide (description or diff) is sent to the AI model for processing to generate the commit message.",
      },
    ],
    keywords: [
      "ai",
  ...
  },
  {
    ...
    longDescription: {
      ...
      howItWorks:
        'Enter your primary topic or keyword. Optionally, describe your target audience. Click "Generate Ideas". The AI will analyze your input and generate a list of potential blog post titles or ideas.',
      tips: [
    ...
    faqs: [
      {
        question: "How many ideas will it generate?",
        answer:
          "The tool typically generates a list of 5-7 ideas per request, but this can vary.",
      },
      {
        question: "Are the ideas unique?",
        answer:
          "AI generates ideas based on patterns and information it has learned. While it aims for creativity, some suggestions might be similar to existing content online. Always add your unique perspective.",
      },
      {
        question: "Is my input topic sent to a server?",
        answer:
          "Yes, your topic and target audience description are sent to the AI model to generate ideas.",
      },
    ],
    keywords: [
      "ai",
  ...
  },
  {
    ...
    description:
      "Quickly summarize long articles, documents, or text passages using AI.",
    category: "ai-powered",
    icon: Icons.ScanLine,
    iconName: "ScanLine",
    ...
    longDescription: {
      overview:
        "The AI Text Summarizer condenses lengthy text into a concise summary. Paste your text, choose a desired summary length (short, medium, or long), and let the AI extract the key points for you. Useful for quickly understanding the gist of an article or document.",
      useCases: [
      ...
      howItWorks:
        'Paste the text you want to summarize into the input area. Select your preferred summary length (short, medium, or long). Click "Summarize". The AI will process the text and generate a summary based on your length preference.',
      tips: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The AI model is primarily trained on English, so summaries for English text will be most accurate. Performance may vary for other languages.",
      },
      {
        question: "Is my text sent to a server?",
        answer:
          "Yes, the input text is sent to the AI model for processing to generate the summary.",
      },
    ],
    keywords: [
      "ai",
  ...
  },
  {
    ...
    description:
      "Upload an image to generate descriptive alt text using AI for better accessibility and SEO.",
    category: "ai-powered",
    icon: Icons.Image,
    iconName: "Image",
    ...
    faqs: [
      {
        question: "What image file types are supported?",
        answer:
          "Common web image formats like PNG, JPEG, GIF, and WEBP are generally supported, as the browser reads the file and converts it to a Data URI.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, for performance and to manage data transfer to the AI model, there is a file size limit, currently set at around 5MB. The tool will provide an error if the file is too large.",
      },
      {
        question: "Is my image data sent to a server?",
        answer:
          "Yes, after you upload the image, its data (converted to a Base64 Data URI format) is sent to the AI model for processing to generate the alt text.",
      },
    ],
    keywords: [
      "ai",
...
export const popularSlugs: PopularSlug[] = [
  {
    slug: "/tools/ai-commit-message-writer",
  },
  {
    slug: "/tools/ai-blog-post-idea-generator",
  },
  {
    slug: "/tools/ai-text-summarizer",
  },
  {
    slug: "/tools/playback-speed-calculator",
  },
  {
  ...
  {
    slug: "/tools/sleep-cycle-calculator",
  },
  {
    slug: "/tools/slope-percentage-calculator",
  },
  {
...
export const getPopularSlugs = (): PopularSlug[] => popularSlugs;
...
export const getSerializableTools = (
  toolsList: Tool[]
): Omit<Tool, "icon">[] => {
